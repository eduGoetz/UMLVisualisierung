...
extern crate rand; // for making a random color.
    //use conrod ::{self, widget, Borderable, Colorable, Positionable, Sizeable, Widget, };

use conrod::{widget, Positionable, Colorable, Widget,color};
...
fn main() {
    ...
    widget_ids!(struct Ids { text, button, rust_logo,canvas});
